...
standardLoopDelay.fromStringConverter = cm.timedelta_converter
...
cleanupJobsLoopDelay.fromStringConverter = cm.timedelta_converter
...
priorityLoopDelay.fromStringConverter = cm.timedelta_converter
