...
def setup_module():
  ...
  me.config = configurationManager.new_configuration(configurationModule = testConfig, applicationName='Testing Postgresql Utils')
...
class TestPostgresql:
  def setUp(self):
    ...
    self.config = configurationManager.new_configuration(configurationModule = testConfig, applicationName='Testing Postgresql Utils')
