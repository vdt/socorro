...
checkForPriorityFrequency.fromStringConverter = cm.timedelta_converter
...
processorCheckInTime.fromStringConverter = lambda x: str(cm.timedelta_converter(x))
...
processorCheckInFrequency.fromStringConverter = cm.timedelta_converter
...
processorLoopTime.fromStringConverter = cm.timedelta_converter
