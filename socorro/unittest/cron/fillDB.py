...
import socorro.cron.top_crashes_by_signature_app as topcrasher
...
def main():
  ...
  config = configurationManager.new_configuration(configurationModule = commonConfig, applicationName='fillSchema.py',configurationOptionsList = addedConfigOptions)
