...
import socorro.cron.top_crashes_by_url_app as tcbu
...
def setup_module():
  ...
  if me:
    return
  me = Me()
  me.config = configurationManager.new_configuration(configurationModule = testConfig, applicationName='Testing TCByUrl')
