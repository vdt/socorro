...
import socorro.cron.builds_app as builds
...
def setup_module():
  ...
  if me:
    return
  me = Me()
  me.config = configurationManager.new_configuration(configurationModule = testConfig, applicationName='Testing builds')
...
class TestBuilds(unittest.TestCase):
  def setUp(self):
    global me
    self.config = configurationManager.new_configuration(configurationModule = testConfig, applicationName='Testing builds')
    ...
    #self.testConfig = configurationManager.Config([('t','testPath', True, './TEST-BUILDS', ''),
                                                  ...
                                                  #])
    self.testConfig = socorro.lib.util.DotDict({'testPath': './TEST-BUILDS',
