...
import socorro.services.adu_by_day_service as abd
...
def testAduByDay__init__():
  ...
  adu = abd.AduByDayService(context)
...
def testAduByDay_get1():
  ...
  class AduByDay2(abd.AduByDayService):
...
def testAduByDay_aduByDay1():
  context = getDummyContext()
  class AduByDay3(abd.AduByDayService):
    def __init__(self, parameters):
