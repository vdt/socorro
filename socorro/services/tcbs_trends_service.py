...
#=================================================================================================================
class TopCrashBySignatureTrendsService(rstapi.JsonServiceBase):
  #-----------------------------------------------------------------------------------------------------------------
  def __init__(self, configContext):
    super(TopCrashBySignatureTrendsService, self).__init__(configContext)
    logger.debug('TopCrashBySignatureTrendsService __init__')
  #-----------------------------------------------------------------------------------------------------------------
  ...
  #-----------------------------------------------------------------------------------------------------------------
  def get(self, *args):
    logger.debug('TopCrashBySignatureTrendsService get')
    convertedArgs = rstapi.typeConversion([str, str, str, dtutil.datetimeFromISOdateString, dtutil.strHoursToTimeDelta, int], args)
    ...
    logger.debug("TopCrashBySignatureTrendsService get %s", parameters)
