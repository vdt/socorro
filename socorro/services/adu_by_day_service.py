...
#=================================================================================================================
class AduByDayService(rstapi.JsonServiceBase):
  #-----------------------------------------------------------------------------------------------------------------
  def __init__(self, configContext):
    super(AduByDayService, self).__init__(configContext)
  ...
  #-----------------------------------------------------------------------------------------------------------------
  def get(self, *args):
    convertedArgs = rstapi.typeConversion([str, semicolonStringToListSanitized, str, semicolonStringToListSanitized, dtutil.datetimeFromISOdateString, dtutil.datetimeFromISOdateString], args)
...
class AduByDay200912(AduByDayService):
  ...
  def get(self, *args):
    ...
    return AduByDayService.get(self, args[0], args[1], 'any', args[2],  args[3], args[4])
