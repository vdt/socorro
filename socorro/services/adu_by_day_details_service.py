...
from socorro.services.adu_by_day_service import semicolonStringToListSanitized
from socorro.services.adu_by_day_service import AduByDayService as AduByDayBase

#=================================================================================================================
class AduByDayDetailsService(AduByDayBase):
  #-----------------------------------------------------------------------------------------------------------------
  def __init__(self, configContext):
    super(AduByDayDetailsService, self).__init__(configContext)
  ...
  #-----------------------------------------------------------------------------------------------------------------
  def get(self, *args):
    convertedArgs = rstapi.typeConversion([str, semicolonStringToListSanitized, semicolonStringToListSanitized, semicolonStringToListSanitized, dtutil.datetimeFromISOdateString, dtutil.datetimeFromISOdateString], args)
