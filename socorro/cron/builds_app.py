...
rc.option('product_uris',
          ...
          default='firefox/nightly/latest-mozilla-1.9.1/,'
                  'firefox/nightly/latest-mozilla-1.9.2/,'
                  'firefox/nightly/latest-mozilla-central/,'
                  'seamonkey/nightly/latest-comm-1.9.1/,'
                  'seamonkey/nightly/latest-comm-central-trunk/,'
                  'thunderbird/nightly/latest-comm-1.9.2/,'
                  'thunderbird/nightly/latest-comm-central/,'
                  'mobile/nightly/latest-mobile-1.9.2/,'
                  'mobile/nightly/latest-mobile-trunk/,'
                  'camino/nightly/latest-2.1-M1.9.2/')
rc.option('platforms',
