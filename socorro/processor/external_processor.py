...
class ProcessorWithExternalBreakpad (processor.Processor):
    ...
    _rc.option('minidump_stackwalkPathname',
    ...
    _rc.option('stackwalkCommandLine',
    ...
    _rc.option('crashingThreadFrameThreshold',
               doc="the number of frames to keep in the raw dump for the "
                   "crashing thread",
               default=100)
    _rc.option('crashingThreadTailFrameThreshold',
               doc="the number of frames to keep in the raw dump at the tail "
                   "of the frame list",
               default=10)
    _rc.option('signatureProcessingClass',
            doc='the class of the signature processor',
            default='socorro.processor.signature_utilities.SignatureUtilities',
    ...
    def __init__(self, config):
        ...
        self.signatureUtilities = config.signatureProcessingClass(config)
